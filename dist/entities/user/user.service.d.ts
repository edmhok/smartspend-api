...
export declare class UserService {
    ...
    constructor(userRepository: UserRepository, productsRepository: ProductsRepository, orderRepository: OrderRepository, affiliateRepository: AffiliateRepository, firstmatrixRepository: FirstmatrixRepository, secondmatrixRepository: SecondmatrixRepository);
